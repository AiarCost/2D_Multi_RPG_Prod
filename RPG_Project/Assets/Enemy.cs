...
public class Enemy : MonoBehaviourPun
{
    ...
    public string[] EnemySpawnText;
    // Start is called before the first frame update
    void Start()
    {
        healthBar.Initialize(enemyName, maxHp);

        int ChoiceText =Random.Range(0, EnemySpawnText.Length);

        ChatBox.instance.photonView.RPC("Log", RpcTarget.All, "Enemy",EnemySpawnText[ChoiceText]);
